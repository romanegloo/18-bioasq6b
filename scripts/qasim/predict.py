...
PATHS['trained_model'] = \
    os.path.join(PATHS['root_dir'], 'data/var/20181210-6b12c3fe-best-acc78.mdl')
PATHS['idf'] = os.path.join(PATHS['root_dir'], 'data/idf.pkl')

p = Predictor(PATHS['trained_model'])
